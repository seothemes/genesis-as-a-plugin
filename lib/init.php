...
function genesis_autoload_register( $class_name ) {
	...
	$file      = GENESIS_DIR . '/lib/classes/class-' . $file_name . '.php';
...
function genesis_autoload_register_psr4( $class_name ) {
	...
	$file      = GENESIS_DIR . '/lib/classes/' . $file_name . '.php';
...
function genesis_i18n() {
	...
	if ( ! defined( 'GENESIS_LANGUAGES_DIR' ) ) {
		define( 'GENESIS_LANGUAGES_DIR', GENESIS_DIR . '/lib/languages' );
	}
...
function genesis_constants() {
	...
	define( 'PARENT_DIR', GENESIS_DIR );
	define( 'CHILD_DIR', get_template_directory() );
	define( 'PARENT_URL', plugin_dir_url( GENESIS_FILE ) );
	define( 'CHILD_URL', get_template_directory_uri() );
...
function genesis_load_framework() {
	...
	$lib_dir = trailingslashit( GENESIS_DIR ) . 'lib/';
